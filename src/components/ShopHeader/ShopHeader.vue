      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" v-for="(support,index) in info.supports"
              :key="index" :class="SupportsClass[support.type]">
            <span class="content-tag">
...
<script>
  ...
  export default {
    data(){
      return{
        SupportsClass:['activity-green','activity-red','activity-orange',],//想对应的满减有的前面的颜色不一样
        supportShow:false,//是否弹出满减优惠的页面
        shopShow:false,//是否弹出商家详细介绍的页面
